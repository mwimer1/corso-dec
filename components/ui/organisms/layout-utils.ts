// components/ui/organisms/layout-utils.ts
// Layout utilities for organisms components

/**
 * Standard max-width classes for responsive container sizing.
 * Used across organisms for consistent layout behavior.
 * This is a facade over the shared layout utilities to avoid cross-domain imports.
 */
