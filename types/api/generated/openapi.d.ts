...
export interface paths {
    ...
    "/api/v1/ai/chat/usage-limits": {
         ...
         *     - `limit`: Total limit for the current period
         *     - `currentUsage`: Current usage count in the period
         *
         *     **Rate Limits:**
         *     - Endpoint: 30 requests per minute
         *     - Deep Research feature: Configurable per user/org (check response for limits)
         */
        get: operations["ai_chat_usageLimits"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
            ...
            200: {
                ...
                content: {
                    ...
                    "application/json": {
                        ...
                        data?: {
                            /**
                             * @description Number of Deep Research requests remaining
                             * @example 5
                             */
                            remaining?: number;
                            /**
                             * @description Total Deep Research limit for current period
                             * @example 10
                             */
                            limit?: number;
                            /**
                             * @description Current usage count in period
                             * @example 5
                             */
                            currentUsage?: number;
                        };
