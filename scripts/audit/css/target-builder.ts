...
export async function buildTargetSet(
  ...
  // In changed mode, we need to also check for all CSS modules if any TS/TSX files changed
  // This is handled by the index builder, but we still want all CSS modules for tool scope calculation
