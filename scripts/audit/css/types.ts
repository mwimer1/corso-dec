...
export interface Finding {
  tool: string;          // stable tool id, e.g. "css-unused-classes"
  ruleId: string;        // stable rule id, e.g. "css/unused-class"
  severity: Severity;
  ...
  // Must be stable across line moves / formatting
  fingerprint: string;
...
export interface ToolContext {
  ...
  // minimal logging hooks (or use your logger)
  log: (msg: string) => void;
