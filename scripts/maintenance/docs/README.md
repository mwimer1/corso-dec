...
status: "draft"
description: "Documentation and resources for documentation functionality. Located in maintenance/docs/."
---
...
- **types.ts** – Shared types and interfaces for documentation operations
