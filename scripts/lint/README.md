...
- **_smoke-runner.ts** – Smoke test runner for migrated lint scripts
...
- **check-filename-case.ts** – Validates that a single filename follows kebab-case naming convention.
