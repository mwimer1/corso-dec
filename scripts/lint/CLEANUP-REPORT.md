...
- Duplicate functionality: `.github/_scripts/workflows-consistency-report.mjs` provides comprehensive coverage
- `lint:workflows:pnpm` correctly uses `.github/_scripts/workflows-consistency-report.mjs`
...
- ✅ `lint:workflows:pnpm` - Still works (uses `.github/_scripts/workflows-consistency-report.mjs`)
