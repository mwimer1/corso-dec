// lib/entities/projects/columns.config.ts

/**
 * @module lib/entities/projects/columns.config
...
export const PROJECTS_COLUMNS: TableColumnConfig[] = [
  ...
  { id: 'status', label: 'Status', accessor: 'status', sortable: true, hidden: false, format: 'badge' },
  ...
  { id: 'description', label: 'Description', accessor: 'description', sortable: true, hidden: false, width: 350, format: 'description' },
  { id: 'property_type_major_category', label: 'Category', accessor: 'property_type_major_category', sortable: true, hidden: false, width: 175, format: 'badge' },
  { id: 'property_type_sub_category', label: 'Sub Category', accessor: 'property_type_sub_category', sortable: true, hidden: false, width: 175, format: 'badge' },
  { id: 'contractor_names', label: 'Contractor(s)', accessor: 'contractor_names', sortable: true, hidden: false, width: 175, format: 'pillList' },
  { id: 'homeowner_names', label: 'Owner(s)', accessor: 'homeowner_names', sortable: true, hidden: false, width: 175, format: 'pillList' },
  ...
  { id: 'project_classification_summary', label: 'Project Types', accessor: 'project_classification_summary', sortable: true, hidden: false, width: 250, format: 'pillList' },
