...
export const ADDRESSES_COLUMNS: TableColumnConfig[] = [
  ...
  { id: 'property_type_major_category', label: 'Use Class', accessor: 'property_type_major_category', sortable: true, hidden: false },
  { id: 'property_type_sub_category', label: 'Sub Type', accessor: 'property_type_sub_category', sortable: true, hidden: false },
