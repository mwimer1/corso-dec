...
status: "active"
description: "Guidelines for contributing to Corso documentation."
---
...
See the [Development Environment Setup Guide](docs/development/setup-guide.md) for complete installation instructions.
```
