...
> ```bash
> pnpm exec tsx scripts/utils/scan-directory.ts app --max-depth 5 --exclude node_modules,.next,dist,coverage,.git > docs/architecture/app-directory-structure.md
> ```
