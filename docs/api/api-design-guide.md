...
- [Warehouse Queries (Canonical)](../architecture/warehouse-queries.md) - Query rules and patterns
...
2. **`types/api/generated/openapi.d.ts`** (from `api/openapi.json`)
   ...
   - **Usage**: `import type { operations, paths } from '@/types/api'`
...
- [Testing Guide](../quality/testing-guide.md) - API testing patterns
