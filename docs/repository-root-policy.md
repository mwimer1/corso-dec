...
**Maintenance Scripts Colocation:**
- **GitHub Scripts**: `.github/_scripts/` - GitHub Actions workflow maintenance scripts
- **Docs Scripts**: `docs/_scripts/` - Documentation maintenance and generation scripts
- *Note: Maintenance scripts that operate exclusively on a specific directory are colocated with that directory using the `_scripts/` naming pattern.*
