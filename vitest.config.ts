    ...
    projects: [
      {
        ...
        test: {
          ...
          include: [
            ...
            'tests/dashboard/**/*.{test,spec}.{ts,tsx}',
            'tests/insights/**/*.{test,spec}.{ts,tsx}',
            'tests/security/**/*.{test,spec}.{ts,tsx}',
            'tests/core/**/*.{test,spec}.{ts,tsx}',
            'tests/runtime-boundary/**/*.{test,spec}.{ts,tsx}',
            'tests/styles/**/*.{test,spec}.{ts,tsx}',
